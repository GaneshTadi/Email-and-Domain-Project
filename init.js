                    ...
                    if (code == 200) {
                        ...
                        if (replace1 !== "Invalid Input") {
                            ...
                            if (replace1.indexOf('blacklist') !== -1) {
                                ...
                                document.getElementById("bemaillab").style.display = "block";
                            }
                            ...
                            document.getElementById("bemaillab").style.display = "noe";
                        ...
                        AppSDK.dispatch("invokeUrl", {
                            ...
                            xhrObj: {
                                ...
                                if (code == 200) {
                                    ...
                                    document.getElementById("bsucc").style.display = "block";
                                    document.getElementById("bsuut").style.display = "block";
                                    document.getElementById("bsuut").textContent = "Successfully Blocklisted";
